...
namespace RM.Server.Common
{
    public abstract class TimerBase
    {
        ...
        public void Submit(ulong callTimeMs, int id)
        {
            TimerDispatcher.Instance.Submit(this, callTimeMs, id);
        }

        public void SubmitImmediately(int id)
        {
            TimerDispatcher.Instance.Submit(this, 1, id);
        }
    }

    public class DelayedTask : TimerBase
    {
