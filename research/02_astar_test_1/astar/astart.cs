...
namespace AStarSharp
{
    public class Node
    {
        ...
        public static int NODE_SIZE = 150;
        public Node Parent;
    ...
    public class Astar
    {
        ...
        public Stack<Node> FindPath(Vector2 Start, Vector2 End)
        {
            ...
            while (OpenList.Count != 0 && !ClosedList.Exists(x => x.Position == end.Position))
            {
                ...
                adjacencies = GetAdjacentNodes8(current);
        ...
        private List<Node> GetAdjacentNodes4(Node n)
        {
        ...
        private List<Node> GetAdjacentNodes8(Node n)
        {
            List<Node> temp = new List<Node>();
