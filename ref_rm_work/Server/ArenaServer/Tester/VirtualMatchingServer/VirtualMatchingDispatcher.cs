...
{
    public abstract class MatchingTimerBase
    {
        public abstract void CallBack(int id);

        public void Send(int id = 0)
        {
            Random rand = new Random();
            VirtualMatchingDispatcher.Instance.Submit(this, (ulong)rand.Next(100, 500), id);
        }
    }

    // Async Task
    public class MatchingTask : MatchingTimerBase
    {
        public MatchingTask(Action action)
        {
            m_action = action;
        }
    ...
    public class VirtualMatchingDispatcher : Singleton<VirtualMatchingDispatcher>
    {
        public class TimerWrapper : StablePriorityQueueNode
        {
            public TimerWrapper(MatchingTimerBase instance, ulong expireTime, int id)
            {
                m_instance = instance;
            ...
            public MatchingTimerBase GetInstance()
            {
                return m_instance;
            }
            ...
            MatchingTimerBase m_instance = null;
        }
        ...
        public virtual bool Submit(MatchingTimerBase instance, ulong callTimeMS, int id)
        {
        ...
        private VirtualMatchingDispatcher()
        {
        }
